...
// DO NOT EDIT OR ADD ANY CODE HERE!
  ...
  private void $$$setupUI$$$()
  {
    ...
    DATABASETextField.setBackground(new Color(-12508876));
    DATABASETextField.setEditable(false);
    DATABASETextField.setForeground(new Color(-11682923));
    DATABASETextField.setHorizontalAlignment(0);
    DATABASETextField.setText("DATABASE");
    panel3.add(DATABASETextField, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
    ...
    CSVTextField.setBackground(new Color(-12508876));
    CSVTextField.setEditable(false);
    CSVTextField.setForeground(new Color(-11682923));
    CSVTextField.setHorizontalAlignment(0);
    CSVTextField.setText("CSV");
    panel4.add(CSVTextField, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
